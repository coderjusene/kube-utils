...
func DiscoveryClient() {
	...
	// APIResourceListSlice是一个切片，里面的每个元素代表一个GroupVersion及其资源
	for _, singleAPIResourceList := range APIResourceListSlice {
		// GroupVersion 是一个字符串，例如"apps/v1"
		groupVerionStr := singleAPIResourceList.GroupVersion

		// ParseGroupVersion 方法将字符串转换程数据结构
		...
		// APIResource字段是一个切片，里面是当前GroupVersion下的所有资源
